    ...
    return (
      <PageContainer>
        <div className="text-center py-16">
          ...
          <Link to="/countries" className="text-primary-600 hover:text-primary-700">
            ← Back to Countries
          </Link>
        </div>
      </PageContainer>
    ...
    <PageContainer>
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <p className="text-lg text-gray-600 mt-1">{country.region}</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-gray-600 leading-relaxed">{country.summaryText}</p>
        ...
        <div className="space-y-8">
          ...
          {country.usageNotes && (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-sm text-gray-600">{country.usageNotes}</p>
            </div>
          )}
        </div>
      </div>
